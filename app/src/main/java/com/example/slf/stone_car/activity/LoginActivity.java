package com.example.slf.stone_car.activity;
...
import com.example.slf.stone_car.Bean._User;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //初始化bmob
        Bmob.initialize(this, "e9b3f89db94b9b215c686e690ffe7bb7");
            ...
            query.findObjects(this, new FindListener<_User>() {
                ...
                public void onSuccess(List<_User> object) {
                    ...
                    for (_User user : object) {
                        Log.d("test3",user.toString());
                        Log.d("test3",user.getCreatedAt());
                        Log.d("test3", "ps...." + user.getPassword());
                        Log.d("test3","na..."+ user.getUsername());

                        Log.d("test3","1");
                        //获得playerName的信息
                        if (password.equals("201649")){
                            Log.d("test3","2");
